...
def load_fhir_resources(collection='bb_fhir',
    ...
    for n in range(start_id_n, end_id_n):
        ...
        if r_p.status_code == 200:
            ...
            logger.debug('Found. Saving Patient info "%s"' % str(n))
        else:
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--confirm', help="confirm action=YES")

        parser.add_argument('--targetcollection', help="Target MongoDB collection")
